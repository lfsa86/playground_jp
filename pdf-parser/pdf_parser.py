"""
PDF Transcriber Library (Parallel Version)

A production-ready tool to transcribe PDF documents to Markdown with tables in HTML
using Google Gemini with parallel processing.

Author: dqniel
Email: danijose1803@gmail.com
GitHub: https://github.com/jdqniel
Created: February 24, 2025
Last Modified: February 24, 2025
License: Proprietary

Copyright (c) Natura Ecova

Description:
    This library provides efficient PDF transcription capabilities with:
